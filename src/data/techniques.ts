...
export const expressHelp = [
  {
    ...
    content: "Сделайте глубокий вдох на 4 счета, задержите дыхание на 4 счета, выдохните на 6 счетов.",
    icon: "Wind",
  ...
  },
  {
    ...
    content: "Назовите 5 предметов, которые видите, 4 вещи, которые можете потрогать, 3 звука, которые слышите, 2 запаха и 1 вкус.",
    icon: "Activity",
    action: "Попробовать",
...
export const assistantDialog = [
  {
    sender: "assistant",
    message: "Здравствуйте! Я ваш ИИ-ассистент по психологической поддержке. Как вы себя чувствуете сегодня?"
  },
  {
    sender: "user",
  ...
  {
    sender: "assistant",
    message: "Я понимаю, что вы испытываете тревогу. Это распространенное чувство. Давайте попробуем несколько техник, которые могут помочь вам прямо сейчас."
  }
];
