...
const mindfulnessTypes = [
  {
    ...
    description: "Самая базовая и доступная техника майндфулнесс - внимательное наблюдение за дыханием",
  ...
  },
  {
    ...
    description: "Техника последовательного перемещения внимания по всему телу для глубокого расслабления",
  ...
  },
  {
    ...
    description: "Практика полного присутствия и внимательности во время приема пищи",
...
const mindfulnessResearch = [
  {
    ...
    description: "Показало, что регулярная практика майндфулнесс увеличивает плотность серого вещества в области гиппокампа, связанной с обучением и памятью.",
    source: "Harvard Gazette"
  },
  {
    title: "Исследование Университета Оксфорда (2013)",
    description: "Выявило, что майндфулнесс-терапия так же эффективна, как антидепрессанты, в предотвращении рецидивов депрессии.",
    source: "Journal of Consulting and Clinical Psychology"
  },
  {
    title: "Исследование Университета Висконсина (2016)",
    description: "Продемонстрировало, что регулярная практика майндфулнесс снижает реактивность на стресс и ускоряет восстановление после стрессовых ситуаций.",
    source: "Journal of Psychosomatic Research"
  }
];

// Компонент таймера для практики
const MeditationTimer: React.FC<{practice: typeof mindfulnessTypes[0]}> = ({ practice }) => {
  const [isRunning, setIsRunning] = useState<boolean>(false);
  const [progress, setProgress] = useState<number>(0);
  const [timerSeconds, setTimerSeconds] = useState<number>(practice.durationMinutes * 60);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#F1F0FB]">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="md:w-1/2">
              <h1 className="text-4xl font-bold mb-6 text-gray-800">Майндфулнесс медитация</h1>
              <p className="text-lg text-gray-600 mb-4">
                Майндфулнесс, или практика осознанности — это состояние сознания, характеризующееся 
                спокойным осознанием и принятием своих чувств, мыслей и телесных ощущений. 
                Это форма медитации, в которой внимание направлено на настоящий момент без оценки и суждений.
              </p>
              
              <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-800">Преимущества практики:</h2>
            ...
            <div className="md:w-1/2">
              ...
              <div className="bg-[#E5DEFF] rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  Практика майндфулнесс уходит корнями в буддистские традиции, насчитывающие более 2500 лет. Однако её современная, секулярная форма была разработана в 1979 году Джоном Кабат-Зинном для программы снижения стресса, основанной на осознанности (MBSR).
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-gray-800">Практики майндфулнесс</h2>
          <p className="text-lg text-gray-600 mb-8">
            Выберите одну из техник майндфулнесс для практики. Каждая техника имеет свои особенности и преимущества. 
            Рекомендуем начинать с коротких сеансов и постепенно увеличивать их продолжительность.
          </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Научные исследования</h2>
            ...
            {mindfulnessResearch.map((research, index) => (
              <Card key={index} className="shadow-md">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-[#9b87f5]">Источник: {research.source}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="bg-[#F1F0FB] p-6 rounded-lg">
            ...
            <p className="mb-4">
              Если вы хотите глубже погрузиться в практику майндфулнесс, рекомендуем следующие книги:
            </p>
            <ul className="space-y-2">
              <li className="flex items-start">
                <Icon name="BookMarked" className="h-5 w-5 text-[#9b87f5] mr-2 flex-shrink-0 mt-0.5" />
                <span>"Куда бы ты ни шел — ты уже там" - Джон Кабат-Зинн</span>
              </li>
              <li className="flex items-start">
                <Icon name="BookMarked" className="h-5 w-5 text-[#9b87f5] mr-2 flex-shrink-0 mt-0.5" />
                <span>"Осознанность: Как обрести гармонию в нашем безумном мире" - Марк Уильямс и Денни Пенман</span>
              </li>
              <li className="flex items-start">
                <Icon name="BookMarked" className="h-5 w-5 text-[#9b87f5] mr-2 flex-shrink-0 mt-0.5" />
                <span>"Медитация и осознанность: 10 минут в день, которые приведут ваши мысли в порядок" - Энди Паддикомб</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                Новичкам рекомендуется начать с простой практики осознанного дыхания. Выделите 5 минут в день, 
                чтобы сесть в удобное положение и просто наблюдать за своим дыханием. Когда вы заметите, что 
                ваш ум отвлекся (а это неизбежно случится), мягко верните внимание к дыханию. Не судите себя 
                за отвлечение — это нормальная часть процесса. Постепенно увеличивайте продолжительность практики.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Для достижения заметных результатов рекомендуется практиковать ежедневно, даже если это всего 5-10 минут в день. 
                Регулярность важнее продолжительности. Исследования показывают, что положительные изменения в мозге начинают 
                проявляться уже после 8 недель регулярной практики по 20-30 минут в день.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Майндфулнесс фокусируется на осознании настоящего момента без оценки, в то время как другие виды медитации 
                могут иметь разные цели: достижение измененных состояний сознания, визуализация, размышления или 
                концентрация на определенном объекте. Майндфулнесс особенно выделяется своим нейтральным, принимающим 
                подходом к возникающим мыслям и чувствам, а также своей доступностью в повседневной жизни.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                Абсолютно! Хотя формальная практика в тихой обстановке важна, суть майндфулнесс — в перенесении осознанности 
                в повседневную жизнь. Вы можете практиковать майндфулнесс во время еды, ходьбы, мытья посуды или даже в разговоре. 
                Просто полностью присутствуйте в том, что делаете, обращая внимание на ощущения, мысли и эмоции без осуждения.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                Да, исследования показывают, что майндфулнесс эффективен при тревожных расстройствах. Практика помогает 
                распознавать тревожные мысли и не отождествляться с ними, а также снижает реактивность нервной системы 
                на стрессовые стимулы. Для клинических тревожных расстройств рекомендуется комбинировать майндфулнесс 
                с другими методами лечения и консультироваться со специалистом.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="overflow-hidden shadow hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mb-4">Техника поочередного напряжения и расслабления групп мышц для снятия физического напряжения.</p>
                <Button variant="outline" className="w-full border-[#9b87f5] text-[#9b87f5] hover:bg-[#9b87f5] hover:text-white" asChild>
